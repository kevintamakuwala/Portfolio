...
const endpoints = ["/", "/projects", "/experience", "/hackathons", "/competitive-programming", "/contact"];
...
const defaultURL = process.env.ENVIRONMENT_URL || "https://kevintamakuwala.vercel.app";
